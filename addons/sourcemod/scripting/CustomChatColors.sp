...
stock Action SQLTableCreation_Ban(Handle timer)
{
	if (g_bSQLite)
		...
		SQL_TQuery(g_hDatabase, OnSQLTableCreated_Ban, "CREATE TABLE IF NOT EXISTS `ccc_ban` (`steamid` VARCHAR(32) NOT NULL, `name` VARCHAR(32) NOT NULL, `issuer_steamid` VARCHAR(32) NOT NULL, `issuer_name` VARCHAR(32) NOT NULL, `length` INT NOT NULL, PRIMARY KEY(`steamid`)) CHARACTER SET utf8 COLLATE utf8mb4_general_ci;");
	return Plugin_Stop;
}
...
stock Action SQLTableCreation_Replace(Handle timer)
{
	if (g_bSQLite)
		...
		SQL_TQuery(g_hDatabase, OnSQLTableCreated_Replace, "CREATE TABLE IF NOT EXISTS `ccc_replace` (`trigger` VARCHAR(32) NOT NULL, `value` VARCHAR(255) NOT NULL, PRIMARY KEY(`trigger`)) CHARACTER SET utf8 COLLATE utf8mb4_general_ci;");
	return Plugin_Stop;
}
